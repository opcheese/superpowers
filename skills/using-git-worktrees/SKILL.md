...
**If `GIT_DIR == GIT_COMMON` (or in a submodule):** You are in a normal repo checkout. Auto-select directory per Step 1b — do not ask for consent (agents branch operates unattended).
